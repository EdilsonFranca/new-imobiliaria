function verificaSeOCampoTemValor2(t, e) {
    var n = [],
        r = document.getElementsByName("minValue2")[0].value,
        i = document.getElementsByName("maxValue2")[0].value;
    return "" == r ? n.push(t) : (t = r, n.push(t)), "" == i ? n.push(e) : (e = i, n.push(e)), n
}

function formatMoney(t, e, n, r) {
    return e = isNaN(e = Math.abs(e)) ? 0 : e, n = void 0 == n ? "," : n, r = void 0 == r ? "." : r, s = 0 > t ? "-" : "", i = parseInt(t = Math.abs(+t || 0).toFixed(e)) + "", j = (j = i.length) > 3 ? j % 3 : 0, s + (j ? i.substr(0, j) + r : "") + i.substr(j).replace(/(\d{3})(?=\d)/g, "$1" + r) + (e ? n + Math.abs(t - i).toFixed(e).slice(2) : "")
}
$(document).ready(function() {
        $(".noUi-handle").on("click", function() {
            $(this).width(50)
        });
        var t = document.getElementsByClassName("slider-range")[1],
            e = verificaSeOCampoTemValor2(2e1, 5e1);
        noUiSlider.create(t, {
            start: [e[0], e[1]],
            step: 1e0,
            range: {
            ...
            document.getElementsByClassName("slider-range-value1")[1].innerHTML = formatMoney(t[0]), document.getElementsByClassName("slider-range-value2")[1].innerHTML = formatMoney(t[1]), document.getElementsByName("minValue2")[0].value = t[0], document.getElementsByName("maxValue2")[0].value = t[1]
        })
    }),
