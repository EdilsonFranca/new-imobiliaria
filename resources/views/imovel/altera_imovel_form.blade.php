@extends('imovel.formulario')
@section ('form')
<form action="/imoveis/adiciona" method="post" enctype="multipart/form-data">
	...
	<div class="row " style="border:thin solid #708090 ; margin-top: 10px;">
		...
		<div class=" col-md-3">
			...
			<input type="text" name="destaque" class="form-control"   {{ $imovel->destaque == 1 ? 'checked='checked'' : '' }}/>
		...
		<div class="form-group col-md-3">
			<?php $transacoes = array("alugar", "venda"); ?>
